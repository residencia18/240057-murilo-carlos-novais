...
class AuthControllerTest {
    ...
    // Teste para verificar o comportamento quando os dados de registro são inválidos
    @Test
    ...
    // Teste para verificar o comportamento quando os dados de registro são válidos
    @Test
    ...
    // Teste para verificar o comportamento quando os dados de login são inválidos
    @Test
    ...
    // Teste para verificar o comportamento quando os dados de login são válidos
    @Test
