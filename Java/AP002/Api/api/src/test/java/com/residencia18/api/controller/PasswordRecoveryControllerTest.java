...
class PasswordRecoveryControllerTest {
    ...
    // Teste para verificar o comportamento de recuperação de senha bem-sucedido
    @Test
    ...
    // Teste para verificar o comportamento quando o usuário não é encontrado durante a recuperação de senha
    @Test
